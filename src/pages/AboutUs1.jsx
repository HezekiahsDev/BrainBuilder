...
const AboutUs1 = () => {
  ...
  return (
    <>
      <div className="w-full h-[1135px] relative bg-[#fafafa] overflow-hidden flex flex-col items-start justify-start pt-[0px] px-[0px] pb-[457px] box-border gap-[90px] leading-[normal] tracking-[normal] mq370:gap-[22px] mq400:gap-[45px] mq407:h-auto">
        <img
          className="w-full h-[698px] absolute !m-[0] top-[60px] right-[0px] left-[0px] max-w-full overflow-hidden shrink-0 object-cover"
           src="\Rectangle 62 (1).png "
          alt=""
        />
        {/* <img
        ...
        <div className="self-stretch flex flex-row items-start justify-center pt-[0px] pb-[50px] pl-[34px] pr-[20px] box-border max-w-full shrink-0 mq400:pb-[32px] mq400:box-border">
          <MainContent />
        </div>
