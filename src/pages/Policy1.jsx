...
const Policy1 = () => {
  ...
  return (
    <>
      <div className="w-full h-[1135px] relative bg-[#fafafa] overflow-hidden flex flex-col items-end justify-start pt-[0px] px-[0px] pb-[456px] box-border gap-[84px] leading-[normal] tracking-[normal] text-center text-[48px] text-[#fff] font-[Nexa] mq361:gap-[21px] mq370:h-auto mq370:gap-[42px]">
        {/* <img
        ...
        <div className="w-[937px] flex flex-row items-start justify-center pt-[0px] px-[20px] pb-[55px] box-border max-w-full shrink-0 mq370:pb-[36px] mq370:box-border">
          <div className="w-[667px] flex flex-col items-start justify-start gap-[16px] max-w-full">
            <div className="self-stretch flex flex-col items-start justify-start gap-[10px] max-w-full">
              <h1 className="m-[0px] w-[144px] relative text-inherit tracking-[0.01em] font-extrabold font-[inherit] inline-block min-h-[73px] z-[1] mq361:text-[29px] mq400:text-[38px]">
                Policy
              </h1>
              <div className="self-stretch flex flex-row items-start justify-start py-[0px] pl-[1px] pr-[0px] box-border max-w-full text-left text-[16px]">
                <div className="flex-1 relative leading-[150%] font-extrabold whitespace-pre-wrap inline-block min-h-[168px] max-w-full z-[2]">
            ...
            <div className="self-stretch flex flex-row items-start justify-start py-[0px] pl-[1px] pr-[0px] box-border max-w-full text-left text-[16px]">
              <div className="flex-1 flex flex-row items-start justify-start relative max-w-full">
                <img
                  className="h-[666px] w-[1335.9px] absolute !m-[0] top-[-351px] left-[-529.9px] object-cover"
                  src="\Brain Builders 14.png"
                  alt=""
                />
        ...
        <footer className="self-stretch flex flex-row items-start justify-center py-[0px] pl-[20px] pr-[34px] box-border max-w-full">
          <FrameComponent7
            propWidth="856px"
            propFlex="unset"
            propMinHeight="unset"
