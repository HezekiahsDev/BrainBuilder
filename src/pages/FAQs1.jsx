...
const FAQs1 = () => {
  ...
  return (
    <>
      <div className="w-full relative bg-[#fafafa] overflow-hidden flex flex-col items-end justify-start gap-[53.3px] leading-[normal] tracking-[normal] text-left text-[16px] text-[#fff] font-[Nexa] mq361:gap-[27px]">
        <img
          ...
          alt=""
        />
        <div className="w-[1532.9px] h-[688.2px] !m-[0] absolute top-[64px] left-[-64px] flex flex-row items-start justify-start">
          <h1 className="!m-[0] w-[494px] absolute top-[90px] right-[438.9px] text-[48px] tracking-[0.01em] font-extrabold font-[inherit] text-center inline-block min-h-[73px] mq370:text-[38px] mq400:text-[29px]">
            Term and Conditions
          </h1>
          <div className="w-[666px] absolute !m-[0] top-[163px] right-[268.9px] leading-[150%] font-extrabold whitespace-pre-wrap inline-block min-h-[168px] z-[1]">
          ...
          <img
            className="h-[762.2px] flex-1 relative max-w-full overflow-hidden object-cover z-[2]"
            src="\HOME PAGE 7 1.png"
            alt=""
          />
          <div className="w-[601.9px] !m-[0] absolute right-[340.1px] bottom-[290.7px] rounded-[6px] bg-[#fff] border-[rgba(11,34,57,0.5)] border-[0.5px] border-solid box-border overflow-hidden shrink-0 flex flex-row items-start justify-start pt-[14px] px-[33px] pb-[9px] gap-[199px] max-w-full z-[3] text-[#002724] font-[Nexa]">
            <div className="w-[370px] flex flex-col items-start justify-start pt-[2px] px-[0px] pb-[0px] box-border max-w-[calc(100%_-_227px)] shrink-0">
              <div className="self-stretch relative leading-[24px]">{`Weius modi tempora incidunt ut labore et dolore? `}</div>
            </div>
            {/* <img className="h-[28px] w-[28px] relative shrink-0" alt="" /> */}
          </div>
          <div className="w-[601.9px] !m-[0] absolute right-[340.1px] bottom-[219.1px] rounded-[6px] bg-[#fff] border-[rgba(11,34,57,0.5)] border-[0.5px] border-solid box-border overflow-hidden shrink-0 flex flex-row items-start justify-between pt-[14px] px-[29px] pb-[10px] gap-[20px] max-w-full z-[3] text-[#002724] font-[Nexa]">
            <div className="w-[370px] flex flex-col items-start justify-start pt-[1px] px-[0px] pb-[0px] box-border max-w-[calc(100%_-_48px)] shrink-0">
              <div className="self-stretch relative leading-[24px]">{`Weius modi tempora incidunt ut labore et dolore? `}</div>
            </div>
            {/* <img className="h-[28px] w-[28px] relative shrink-0" alt="" /> */}
          </div>
        </div>
        <header className="self-stretch h-[64px] relative z-[3] text-center text-[16px] text-[#000] font-[Nexa]">
        ...
        <div className="w-[1266px] flex flex-row items-start justify-end py-[0px] px-[80px] box-border max-w-full mq361:pl-[40px] mq361:pr-[40px] mq361:box-border">
          <div className="h-[1017.7px] flex-1 flex flex-col items-start justify-start pt-[0px] px-[0px] pb-[457px] box-border gap-[140px] max-w-full lg:gap-[70px] lg:pb-[297px] lg:box-border mq361:h-auto mq361:gap-[35px] mq361:pb-[193px] mq361:box-border mq400:gap-[17px]">
            <ContentInner />
            <footer className="w-[1078px] flex flex-row items-start justify-center py-[0px] px-[20px] box-border max-w-full">
              <FrameComponent7
                propWidth="856px"
                propFlex="unset"
                propMinHeight="unset"
